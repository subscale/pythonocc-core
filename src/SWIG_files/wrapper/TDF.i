...
None
") EntryDump;
		void EntryDump(std::ostream & anOS);
...
None
") ExtendedDump;
		void ExtendedDump(std::ostream & anOS, const TDF_IDFilter & aFilter, TDF_AttributeIndexedMap & aMap);
...
std::ostream
") Dump;
		std::ostream & Dump(const Standard_Boolean dumpLabels, const Standard_Boolean dumpAttributes, const Standard_Boolean dumpTransients, std::ostream & anOS);
...
") DeepDump;
		...
		%feature("compactdefaultargs") DeepDump;
		%feature("autodoc", "Dumps <alabel>, its children and their attributes.
...
") ExtendedDeepDump;
		...
		%feature("compactdefaultargs") ExtendedDeepDump;
		%feature("autodoc", "Dumps <alabel>, its children and their attributes, if their ids are kept by <afilter>. dumps also the attributes content.
